...
- Continuing the progress @isyuck has made with the TidalCycles configuration
 - OSC to Hydra (OSC is a communication bridge)
 - OSC to Wekinator (for text-to-sound, text-to-visuals conversion)
 - Chat to MIDI Out
